...
<div class="container col-md-6 px-4 py-5" >
         ...
         <h1 class="h3 mb-3 text-center">Vendor Signup</h1>
 ...
 <form action="process/vendor_process_signup.php" method="post"> 
...
<div class="col-md-6">
    ...
    <label for="floatingcname">Company Name</label>
      <input type="text" name="cname" class="form-control" id="floatingfname" placeholder="Companyname">
   ...
   <div class="col-md-6">
    ...
    <label for="floatingfname">Full Name</label>
      <input type="text" name="fname" class="form-control" id="floatinglname" placeholder="Fullname">
    ...
    <button class="btn btn-danger w-50" type="submit" name="btnsignup" value="register">Create Account</button>

    <div class="form-floating">
      <p class="float-end"> Have an account? <a href="vendor_login.php">Login</a>   </p>
    </div>
