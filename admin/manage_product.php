                                            ...
                                            foreach($t as $product){
                                             ...
                                             ?>
                                               <tr>
                                                 ...
                                                 <a onclick="return confirm('Are you sure you want to delete product?')" href="delete_product.php?id=<?php echo $product['product_id']; ?>" class="btn btn-sm btn-danger"> Delete </a> 
